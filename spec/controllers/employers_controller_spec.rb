  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved employer as @employer" do
        ...
        Employer.any_instance.stub(:save).and_return(false)
        post :create, {:employer => { "name" => "invalid value" }}, valid_session
        assigns(:employer).should be_a_new(Employer)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested employer" do
        employer = Employer.create! valid_attributes
        # Assuming there are no other employers in the database, this
        # specifies that the Employer created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        Employer.any_instance.should_receive(:update_attributes).with({ "name" => "MyString" })
        put :update, {:id => employer.to_param, :employer => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the employer as @employer" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Employer.any_instance.stub(:save).and_return(false)
        put :update, {:id => employer.to_param, :employer => { "name" => "invalid value" }}, valid_session
        assigns(:employer).should eq(employer)
      end
